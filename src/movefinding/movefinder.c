...
void move_finder(Position_t *position)
{
    ...
    while (queen_bitboard)
    {
        ...
        generate_new_positions(QUEEN, possible_move_squares, from_square_bitboard, 0);
    ...
    while (rook_bitboard)
    {
        ...
        possible_move_squares = rook_attack_lookup_table[from_square][index];
        possible_move_squares &= ~active_pieces_bitboard;
        generate_new_positions(ROOK, possible_move_squares, from_square_bitboard, 0);
    ...
    while (bishop_bitboard)
    {
        ...
        possible_move_squares = bishop_attack_lookup_table[from_square][index];
        possible_move_squares &= ~active_pieces_bitboard;
        generate_new_positions(BISHOP, possible_move_squares, from_square_bitboard, 0);
    ...
    while (knight_bitboard)
    {
        ...
        generate_new_positions(KNIGHT, possible_move_squares, from_square_bitboard, 0);
    ...
    while (pawn_bitboard)
    {
        ...
        if (rank != seventh_rank) {
            ...
            while (possible_move_squares)
            {
                ...
                generate_new_positions(PROMOTE_QUEEN, to_square_bitboard, from_square_bitboard, 0);
                generate_new_positions(PROMOTE_ROOK, to_square_bitboard, from_square_bitboard, 0);
                generate_new_positions(PROMOTE_BISHOP, to_square_bitboard, from_square_bitboard, 0);
                generate_new_positions(PROMOTE_KNIGHT, to_square_bitboard, from_square_bitboard, 0);
